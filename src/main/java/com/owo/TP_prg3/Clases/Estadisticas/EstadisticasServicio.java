...
public class EstadisticasServicio {
    ...
    public CierreCajaDTO obtenerMovimientosCajaDiaria(LocalDate fecha) {
        var inicioDT = fecha.atStartOfDay();
        var finDT = fecha.atTime(LocalTime.MAX);
        ...
        BigDecimal ajustes = statsRepo.sumAjustesCajaEnRango(inicioDT, finDT);
        ...
        return CierreCajaDTO.builder()
                ...
                .ajustesHoy(ajustes != null ? ajustes : BigDecimal.ZERO)
                .build();
    }
}