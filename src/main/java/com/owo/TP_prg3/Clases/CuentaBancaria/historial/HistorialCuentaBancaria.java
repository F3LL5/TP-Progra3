...
@Entity
@Table(name = "historial_cuenta_bancarias")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class HistorialCuentaBancaria {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "historial_cuenta_bancaria_id", unique = true)
    private Long historialCuentaBancariaId;
